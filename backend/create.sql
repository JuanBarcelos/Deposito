...
create table tb_product (id int8 generated by default as identity, image_uri varchar(255), name varchar(255), price float8, quantidade int4 not null, primary key (id));
